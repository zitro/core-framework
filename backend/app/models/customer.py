...
Sources. A Source is a connected content location — a GitHub repo (engagement-repo
...
(targets for "push to engagement-repo" from /execute).
...
class SourceRole(StrEnum):
    VERTEX = "engagement-repo"  # follows engagement-repo spec (`{repo}/{customer-slug}/`)
...
class Customer(BaseModel):
    """A customer (e.g. Customer). Groups Engagements and owns Sources."""

    id: str = ""
    slug: str  # kebab-case; matches engagement-repo repo subdir convention
    display_name: str
    industry: str = ""
    summary: str = ""
