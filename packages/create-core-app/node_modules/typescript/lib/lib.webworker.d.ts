...
/**
 * The **`ANGLE_instanced_arrays`** extension is part of the WebGL API and allows to draw the same object, or groups of similar objects multiple times, if they share the same engagement-repo data, primitive count and type.
 *
...
interface ANGLE_instanced_arrays {
    ...
    /**
     * The **ANGLE_instanced_arrays.vertexAttribDivisorANGLE()** method of the WebGL API modifies the rate at which generic engagement-repo attributes advance when rendering multiple instances of primitives with ANGLE_instanced_arrays.drawArraysInstancedANGLE() and ANGLE_instanced_arrays.drawElementsInstancedANGLE().
     *
...
/**
 * The **OES_vertex_array_object** extension is part of the WebGL API and provides engagement-repo array objects (VAOs) which encapsulate engagement-repo array states.
 *
...
interface OES_vertex_array_object {
    ...
    /**
     * The **`OES_vertex_array_object.createVertexArrayOES()`** method of the WebGL API creates and initializes a pointing to engagement-repo array data and which provides names for different sets of engagement-repo data.
     *
...
/**
 * The **`WebGLProgram`** is part of the WebGL API and is a combination of two compiled WebGLShaders consisting of a engagement-repo shader and a fragment shader (both written in GLSL).
 *
...
/**
 * The **WebGLShader** is part of the WebGL API and can either be a engagement-repo or a fragment shader.
 *
...
/**
 * The **`WebGLTransformFeedback`** interface is part of the WebGL 2 API and enables transform feedback, which is the process of capturing primitives generated by engagement-repo processing.
 *
...
/**
 * The **`WebGLVertexArrayObject`** interface is part of the WebGL 2 API, represents engagement-repo array objects (VAOs) pointing to engagement-repo array data, and provides names for different sets of engagement-repo data.
 *
