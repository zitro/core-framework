...
/**
 * EngagementRepo repo viewer (v2.0).
 *
 * Tree of markdown/json files in the connected engagement-repo repo on the left,
...
import { VertexDropZone } from "@/components/engagement-repo/drop-zone";
...
export default function VertexPage() {
  ...
  if (loading && !tree) {
    return <Hero title="Reading engagement-repo repoâ€¦" body="" />;
  }
  if (tree && !tree.available) {
    return (
      <Hero
        title="No engagement-repo repo connected"
