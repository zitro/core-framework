      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            <GitBranch className="size-4" aria-hidden /> GitHub (engagement-repo repo)
          </CardTitle>
          <CardDescription>
            CORE Discovery reads and writes your engagement&apos;s engagement-repo repo
            through a Source on the active customer. Add a GitHub source there
            with a personal access token and pick &quot;EngagementRepo&quot; as the role.
          </CardDescription>
        </CardHeader>
...
function PreferencesPanel() {
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">EngagementRepo write-back</CardTitle>
        </CardHeader>
        <CardContent className="text-sm text-muted-foreground">
          Bidirectional write-back to the connected engagement-repo repo is controlled per project via the
          project metadata flag <code>engagement-repo.metadata.write_enabled</code>. A UI toggle is on the
          roadmap.
        </CardContent>
      </Card>
      <Card>
