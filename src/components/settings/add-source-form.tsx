...
export function AddSourceForm({ onAdd, kinds, roles }: Props) {
  ...
  const [role, setRole] = useState<SourceRole>("engagement-repo");
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <Field label="Label">
          <Input
            ...
            placeholder="Customer engagement-repo"
          />
        </Field>
        <Field label="Kind">
        ...
        <Field label={kind === "github" ? "owner/repo" : "Path"}>
          <Input
            ...
            placeholder={kind === "github" ? "org/customer" : "/data/customer"}
          />
        </Field>
        {kind === "github" && (
          <>
