...
/**
 * AddItemDialog — short modal that appends a free-form note about a new
 * item (persona, workstream, pain point, …) and asks the AI to fold it
 * into the targeted artifact (and, optionally, its category siblings).
 *
 ...
 *
 * Submit is the only LLM trigger — there is no on-mount auto-fire.
 */
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {propagate
              ? " and related artifacts in the same category."
              : "."}
          </DialogDescription>
        </DialogHeader>
