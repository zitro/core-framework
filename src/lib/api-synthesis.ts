...
export const synthesisApi = {
  ...
  writebackVertex: (projectId: string) =>
    request<SynthesisWriteBackResult>(
      `/api/synthesis/${encodeURIComponent(projectId)}/writeback/engagement-repo`,
      { method: "POST" },
    ),
  ...
  updateVertexSettings: (
    ...
    request<{ engagement-repo: { write_enabled: boolean; write_subdir?: string | null } }>(
      `/api/synthesis/${encodeURIComponent(projectId)}/settings/engagement-repo`,
      {
        method: "PUT",
